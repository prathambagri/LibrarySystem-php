  ...
  <div class="card-body">
    ...
    <div class="form-row">
    	<div class="col-md-6">
			...
			<div class="form-group"><label class="small mb-1" for="Category">Category</label> : <p><?php echo  $object->Category ?></p></div>
			<div class="form-group"><label class="small mb-1" for="Rating">Rating</label> : <p><?php echo $object->Rating;?></p></div>
