            ...
            <div class="pricing">
              ...
              <div class="pricing-body">
                ...
                <div class="form-group" id="BookTitle">
                  <div class="row">
                    <label class="col-md-2 control-label" for="BookTitle">Title:</label>

                    <div class="col-md-10">
                      <input class="form-control input-lg" id="BookTitle" name="BookTitle" placeholder="Title" type="text" value="">
                    </div>
                ...
                <div class="form-group" id="Author">
                  <div class="row">
                    ...
                    <div class="col-md-10">
                      <input class="form-control input-lg" id="Author" name="Author" type="text" placeholder="Author">
                    </div>
                ...
                <div class="form-group" id="BookPublisher">
                  <div class="row">
                    <label class="col-md-2 control-label" for="BookPublisher">Publisher:</label>

                    <div class="col-md-10">
                      <input class="form-control input-lg" id="BookPublisher" name="BookPublisher" type="text" placeholder="Publisher">
                    </div>
                ...
                <div class="form-group" id="PublishDate">
                  <div class="row">
                    <label class="col-md-2 control-label" for="PublishDate">Date:</label>

                    <div class="col-md-10">
                      <input class="form-control input-lg datepicker" id="datepicker" name="PublishDate" type="text" placeholder="Published Date" data-inputmask="'alias': 'date'">
                    </div>
