...
class Database {
	...
	public function open_connection() {
		...
		if (!$this->conn) {
			throw new Exception("Failed to connect to the database server: " . mysqli_connect_error());
		} else {
			$db_select = mysqli_select_db($this->conn, database_name);
			if (!$db_select) {
				throw new Exception("Failed to select the database: " . mysqli_error($this->conn));
			}
		}
	}
